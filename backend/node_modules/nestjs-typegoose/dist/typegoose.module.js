...
let TypegooseModule = TypegooseModule_1 = class TypegooseModule {
    ...
    static forFeature(models, connectionName) {
        const convertedModels = models.map(model => typegoose_providers_1.convertToTypegooseClassWithOptions(model));
        const providers = typegoose_providers_1.createTypegooseProviders(connectionName, convertedModels);
        return {
            module: TypegooseModule_1,
            providers,
            exports: providers
